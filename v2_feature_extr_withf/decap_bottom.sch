...
N 320 -400 320 -350 {lab=vdd}
N 220 -400 320 -400 {lab=vdd}
N 120 -400 120 -350 {lab=vdd}
N 220 -400 220 -350 {lab=vdd}
N 120 -400 220 -400 {lab=vdd}
N 70 -400 120 -400 {lab=vdd}
N 120 -260 320 -260 {lab=vss}
N 120 -260 120 -230 {lab=vss}
N 320 -260 320 -230 {lab=vss}
N 120 -140 320 -140 {lab=vdd}
N 120 -170 120 -140 {lab=vdd}
N 320 -170 320 -140 {lab=vdd}
N 220 -10 320 -10 {lab=vss}
N 120 -50 120 -10 {lab=vss}
N 320 -50 320 -10 {lab=vss}
N 120 -290 120 -260 {lab=vss}
N 220 -290 220 -230 {lab=vss}
N 320 -290 320 -260 {lab=vss}
N 70 -260 120 -260 {lab=vss}
...
C {iopin.sym} 70 -400 2 0 {name=pin_vdd lab=vdd}
C {iopin.sym} 70 -260 2 0 {name=pin_vss lab=vss}
C {lab_wire.sym} 220 -260 0 0 {name=p1 sig_type=std_logic lab=vss}
C {lab_wire.sym} 220 -140 0 0 {name=p2 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 220 -20 0 0 {name=p3 sig_type=std_logic lab=vss}
