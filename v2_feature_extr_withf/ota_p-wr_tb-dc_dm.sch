...
N 700 -660 970 -660 {
lab=v_in}
N 900 -600 900 -480 {lab=vcm}
N 800 -420 800 -380 {lab=v_ss}
N 600 -380 800 -380 {
lab=v_ss}
N 700 -510 700 -480 {lab=vcm}
N 700 -480 900 -480 {lab=vcm}
N 1080 -440 1080 -380 {lab=v_ss}
N 1080 -550 1080 -500 {lab=#net1}
N 1080 -380 1300 -380 {
lab=v_ss}
N 800 -380 1040 -380 {
lab=v_ss}
...
C {devices/vsource.sym} 700 -540 0 0 {name=Vdm value="dc 5m"}
C {devices/lab_wire.sym} 860 -480 0 0 {name=p7 sig_type=std_logic lab=vcm}
C {devices/vsource.sym} 1080 -470 0 0 {name=Vbias value="dc 0.3"}
