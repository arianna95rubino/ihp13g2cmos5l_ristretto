...
C {devices/vsource.sym} -656.25 -302.5 0 0 {name=Vcm1 value="dc 0.65"}
C {devices/vsource.sym} -573.75 -308.75 0 0 {name=Vcm2 value="dc 0.59"}
...
*.param amp=1m
.control
.options gmin=1e-15 rshunt=1e12 reltol=1e-3 abstol=1e-9 vntol=1e-6
